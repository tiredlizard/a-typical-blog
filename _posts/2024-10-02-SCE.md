...
---
<p class="intro"><span class="dropcap">S</span>o, you woke up this morning and wondered "what in the heck is an SCE object?". Just kidding, no one does that. That's why I'm here to tell you about something most people will never use! Don't be alarmed by the '9 Minute Read'; you can skim it in, like, a minute. </p>
...
Since I have to include some form of data science in this post, I suppose I will go over the basic things you can do with the SCE object. (Hopefully this counts as data science? Since it's science... using data?)
...
This is quite an abrupt cut-off, but I'm already running too long and my creativity is long gone. If you want to know more, like, comment, and subscr - no, that's the wrong platform.
